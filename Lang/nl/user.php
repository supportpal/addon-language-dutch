...
return array(
    ...
    "registered_desc"               => "Geeft aan of de gebruiker een wachtwoord heeft ingesteld en kan inloggen op de frontend.",
    "new_operator_account_desc"     => "U kunt een verificatie-e-mail sturen zodat de operator zelf zijn account kan instellen, of hieronder een wachtwoord voor hem/haar instellen.",
    "operator_set_password_desc"    => "Voer hieronder een wachtwoord in om het instellen van uw operatoraccount te voltooien.",
    "password_set_success"          => "Wachtwoord succesvol ingesteld!",

    /*
     * 5.7.0
     */
    "reply_template_cursor_position" => "Gebruik de optie 'Cursorpositie instellen' in de editor om te bepalen waar de cursor wordt geplaatst wanneer de gebruiker de editor opent om op een ticket te reageren.",
    "system_bot_desc"               => "Dit is een systeem-botaccount dat wordt gebruikt voor geautomatiseerde acties. U kunt alleen de naam en avatar bewerken.",
    "notification_settings"         => "Meldingsinstellingen",
    "operator_notifications"        => "Operatormeldingen",
    "operator_notifications_desc"   => "Werk de meldingsvoorkeuren voor het operatoraccount bij.",
    "default_department_subscription" => "Standaard afdelingsabonnement",
    "default_department_subscription_desc" => "Stel het standaard meldingsabonnement in dat bepaalt wanneer meldingen worden verzonden bij ticketgebeurtenissen. Dit abonnement wordt gebruikt voor afdelingen waarvoor geen specifiek abonnement is ingesteld.",
    "department_subscriptions"      => "Afdelingsabonnementen",
    "department_subscriptions_desc" => "Pas het meldingsabonnement per afdeling aan.",
    "subscription_type"             => "Type abonnement",
    "subscription_default"          => "Standaard",
    "subscription_default_desc"     => "Gebruik het standaard afdelingsabonnement voor deze afdeling.",
    "subscription_all_activity"     => "Alle activiteit",
    "subscription_all_activity_desc" => "Ontvang meldingen over alle activiteit in deze afdeling.",
    "subscription_unassigned_and_assigned" => "Niet toegewezen en toegewezen",
    "subscription_unassigned_and_assigned_desc" => "Ontvang meldingen wanneer er geen toegewezen operator is, of wanneer u bent toegewezen. Meldingen worden ook verzonden bij volgen of @vermeldingen.",
    "subscription_assigned_only"    => "Alleen toegewezen",
    "subscription_assigned_only_desc" => "Ontvang alleen meldingen voor deze afdeling wanneer u aan het ticket bent toegewezen. Meldingen worden ook verzonden bij volgen of @vermeldingen.",
    "subscription_ignore"           => "Negeren",
    "subscription_ignore_desc"      => "Ontvang geen meldingen voor activiteit in deze afdeling, behalve bij volgen of @vermeldingen.",
    "configure_on_operator_notifications" => "Afdelingsspecifieke meldingsabonnementen kunnen worden ingesteld op de pagina <a href=':route' target='_blank'>operatormeldingen</a>.",
    "notification_channel_email"    => "E-mail",
    "notification_channel_browser"  => "Browser",
    "browser_notifications_desc"    => "Het systeem zal u via de browser op de hoogte stellen van bepaalde gebeurtenissen. U kunt kiezen voor desktopmeldingen, in-app meldingen of deze volledig uitschakelen.",
    "failed_login_notification"     => "Mislukte inlogpoging operator",
    "failed_login_notification_desc" => "Waarschuwt u wanneer iemand niet kan inloggen op het operatorpaneel of wanneer een IP-adres wordt geblokkeerd na meerdere mislukte inlogpogingen.",
    "notifications_desc"            => "Selecteer via welke kanalen u meldingen wilt ontvangen over systeemgebeurtenissen, of schakel afzonderlijke meldingen uit.",
    "in_app_notifications"          => "In-app meldingen",

    /*
     * 6.0.0
     */
    "ldap_start_tls_desc"           => "Of er eerst een onveilige verbinding wordt opgezet en daarna wordt opgewaardeerd met StartTLS. Als u het LDAPS-protocol gebruikt, moet deze optie worden uitgeschakeld.",
    "ldap_ca_cert"                  => "CA-certificaat",
    "ldap_ca_cert_desc"             => "Upload optioneel het CA-certificaat van de LDAP-server. Dit is alleen nodig bij gebruik van zelfondertekende certificaten.",
    "ldap_server"                   => "LDAP-server|LDAP-servers",
    "ldap_server_hostname"          => "Hostnaam",
    "ldap_server_name_desc"         => "Een herkenbare naam om deze LDAP-server te identificeren.",
);
