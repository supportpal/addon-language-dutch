...
return array(
     ...
     * 2.0.3
     */
    "operator_ticket_replies"   => "Operator Ticket antwoorden",
    ...
    "ticket_by_priority"        => "Tickets op prioriteiten",
     ...
     * 2.1.0
     */
    "reports_dashboard"         => "Rapport dashboard",
    "ticket_by_brand"           => "Tickets per merk",
    "ticket_by_brand_desc"      => "Het aantal tickets per merk gedurende een bepaalde periode.",
    "ticket_by_user"            => "Tickets per gebruiker",
