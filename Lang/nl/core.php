...
return array(
    ...
    // Activity Log Groups
    "ticket_events"             => "Ticketgebeurtenissen",
    "user_events"               => "Gebruikersgebeurtenissen",
    "organisation_events"       => "Organisatiegebeurtenissen",
    "email_events"              => "E-mailgebeurtenissen",
    "system_events"             => "Systeemgebeurtenissen",
    "selfservice_events"        => "Selfservicegebeurtenissen",
    "ip_events"                 => "IP-gebeurtenissen",
    "login_events"              => "Inloggebeurtenissen",
    "export_events"             => "Exportgebeurtenissen",
    "addon_events"              => "Addon-gebeurtenissen",
    "private_conversation_events" => "Privéconversatiegebeurtenissen",
    "import_events"             => "Importgebeurtenissen",
    "background_job_events"     => "Achtergrondtaakgebeurtenissen",
    "user_profile"              => "Profielupdates",
    "user_organisation"         => "Organisatie-updates",
    "user_groups"               => "Wijzigingen in groepslidmaatschappen",
    "user_password"             => "Wachtwoordwijzigingen",
    "user_merge"                => "Samenvoeggebeurtenissen",
    "email_mass"                => "Massale e-mailgebeurtenissen",
    "email_sent"                => "Verzonden e-mails",
    "misc_events"               => "Diverse gebeurtenissen",
    "system_tasks"              => "Geplande taakgebeurtenissen",
    "system_jobs"               => "Achtergrondtaakgebeurtenissen",
    "system_items"              => "Aangemaakte, bijgewerkte & verwijderde records",
    "selfservice_articles"      => "Artikelgebeurtenissen",
    "selfservice_comments"      => "Reactiegebeurtenissen",
    "selfservice_feedback"      => "Feedbackgebeurtenissen",
    "email_throttled"           => "Te veel binnenkomende e-mails van gebruiker. De limiet is :max_requests tokens per :decay_time minuten.",
    "debug_mode_desc"           => "Schakel uitgebreide debug-mogelijkheden in. Wanneer ingeschakeld, wordt er extra diagnostische informatie naar de logbestanden geschreven, die gedownload kunnen worden via Hulpprogramma's -> Logs -> Logbestandsbeheer.",
    "debug_mode_warning"        => "De debug-modus mag alleen tijdelijk worden ingeschakeld om te voorkomen dat er te grote logbestanden worden gegenereerd.",
    "debug_mode_error"          => "App-debug mag niet worden ingeschakeld in productie en zal fouten tonen aan gebruikers, zet APP_DEBUG op false. Gebruik in plaats daarvan de optie voor debug-modus in de algemene instellingen.",
